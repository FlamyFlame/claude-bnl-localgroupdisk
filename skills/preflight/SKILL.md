---
description: >
  Run pre-flight checks for LOCALGROUPDISK migration: verify Rucio account,
  grid proxy, quotas, RSE names, and pnfs mount availability on BNL SDCC.
  Use before starting any migration.
allowed-tools: Bash
---
